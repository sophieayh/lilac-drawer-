  ...
  return (
    <>
      ...
      <main className="bg-cream text-purple-deep min-h-screen py-6 sm:py-8 px-4 sm:px-6 md:px-12">
        <div className="max-w-[1400px] mx-auto flex flex-col gap-6 sm:gap-10">
          {/* Breadcrumbs */}
          <nav aria-label="Breadcrumbs" className="flex items-center gap-2 text-xs text-tan-dark overflow-x-auto no-scrollbar whitespace-nowrap">
          ...
          <div className="border-b border-border pb-5 sm:pb-6 flex flex-col gap-3 sm:gap-4">
            <div className="flex flex-col gap-1">
              <span className="text-xs font-bold uppercase tracking-widest text-rose">
                Category Guide
              </span>
              <h1 className="font-heading text-2xl sm:text-3xl md:text-4xl text-purple-deep tracking-tight">
                {activeSubItem ? activeSubItem.label : categoryLabel}
              </h1>
              <p className="text-xs sm:text-sm md:text-base text-tan-dark max-w-2xl mt-1 leading-relaxed">
            ...
            {subcategories.length > 0 && (
              <div className="flex items-center gap-2 overflow-x-auto pt-2 pb-1 no-scrollbar -mx-4 px-4 sm:mx-0 sm:px-0">
                <Link
                  href={`/category/${slug}`}
          ...
          {articles.length > 0 && (
            <div className="bg-mauve-50/40 border border-border/80 rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8">
              <ArticleCarousel
                articles={articles}
          ...
          <section className="flex flex-col gap-6">
            <div className="flex items-center justify-between gap-4 border-b border-border pb-4 flex-wrap">
              <div>
                ...
                <h2 className="font-heading text-xl sm:text-2xl text-purple-deep mt-0.5">
            ...
            {products.length === 0 ? (
              <div className="py-12 sm:py-16 text-center border-2 border-dashed border-border rounded-2xl bg-white p-6 sm:p-8">
                <p className="font-heading text-base sm:text-lg text-purple-deep">No products found in this category yet.</p>
