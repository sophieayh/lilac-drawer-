...
export default async function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen flex bg-[#fbf6f0]">
      {/* Desktop Sidebar */}
      <aside className="w-64 shrink-0 border-l border-border-mauve bg-white hidden md:flex md:flex-col shadow-[-2px_0_12px_rgba(46,37,54,0.03)] z-20">
        {/* Brand Header */}
        ...
        <div className="p-4 border-t border-border/80 bg-mauve-50/50">
          <div className="flex items-center gap-2.5 mb-3">
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="text-[10px] text-tan">حساب المشرف</div>
            </div>
          </div>
          <a
            href={SITE_URL}
